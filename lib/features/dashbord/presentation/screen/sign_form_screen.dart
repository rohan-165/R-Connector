...
import 'package:r_connector/features/dashbord/presentation/cubit/sign_cubit.dart';
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              BlocBuilder<SignCubit, AbsNormalState>(
                builder: (context, state) {
                  return ButtonWidget(
                    isLoading: state.absNormalStatus == AbsNormalStatus.LOADING,
                    onTap: () {
                      if (_formKey.currentState!.validate()) {
                        final filePath =
                            getIt<PdfCubit>().state.data?.fileName ?? '';
                        getIt<SignCubit>().signPost(
                          filePath: filePath,
                          signPage: signPage.value,
                          certificateFileSource: certificateFileSource.value,
                          stampSource: stampSource.value,
                          qrImageSource: qrImageSource.value,
                          unsignedSource: unsignedSource.value,
                          publicCertificateFileSource:
                              publicCertificateFileSource.value,
                          stampRoText: stampRoText.value,
